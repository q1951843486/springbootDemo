...
public class PDFUtils {
    ...
    public static String cratePDFByClass(String targetPath, IdentityPrint identityPrint,InputStream inputStream){
        ...
        try {
           ...
           acroFields.setField("name",identityPrint.getName());
           acroFields.setField("idCard",identityPrint.getIdCard());
           acroFields.setField("startDate",identityPrint.getStartDate());
           acroFields.setField("result",identityPrint.getResult());
