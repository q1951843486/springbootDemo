...
public class DateUtil {
    ...
    /**
     * 
     * Description: 将字符串日期转指定日期格式
     * @param date  例如 20200202   yyyyMMdd 转 yyyy年MM月dd日
     * @param nowFormat yyyyMMdd
     * @param newFormat yyyy年MM月dd日
     * @return
     */
    public static String getSpecifiedDate(String date,String nowFormat,String newFormat) {
    	if(StringUtils.isEmpty(date.trim())) {
    		return "";
    	}
    	SimpleDateFormat format = new SimpleDateFormat(nowFormat);
    	try {
