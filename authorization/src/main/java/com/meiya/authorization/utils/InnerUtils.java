...
public class InnerUtils {
    ...
    private static  final  String CERTIFICATE_PATH="client.p12";
    ...
    private static HttpClient wrapClient(String host) throws KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
        ...
        if(host.startsWith("https")){
            ...
            try (InputStream instream = new ClassPathResource(CERTIFICATE_PATH).getInputStream()) {
                try {
            ...
            sslcontext = SSLContexts.custom().loadKeyMaterial(keyStore,CERTIFICATE_PASSWORD.toCharArray()).build();
